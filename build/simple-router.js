...
var defaultEventObject = {
    postRouteProcessing: function postRouteProcessing(data) {
        data.incrementor = 0;
        return Promise.resolve(data);
    },
    preContentFetch: function preContentFetch(data) {
        data.incrementor = 1;
        return Promise.resolve(data);
    },
    postContentFetch: function postContentFetch(data) {
        data.incrementor = 2;
        return Promise.resolve(data);
    },
    ...
    preContentLoad: function preContentLoad(data) {
        data.incrementor = 4;
        return Promise.resolve(data);
    },
    postContentLoad: function postContentLoad(data) {
        data.incrementor = 5;
        return Promise.resolve(data);
    },
    postLinkHandle: function postLinkHandle(data) {
        data.incrementor = 6;
        return Promise.resolve(data);
    }
};
...
var SimpleRouter = exports.SimpleRouter = function () {
    ...
    _createClass(SimpleRouter, [{
        ...
        value: function handleRoute(selectedRoute) {
            ...
            var route = selectedRoute.route;
            return new Promise(function (resolve, reject) {
                route.events.postRouteProcessing(data).then(function (data) {
                    route.events.preContentFetch(data).then(function (data) {
                        // throw 'ex';
                        route.events.postContentFetch(data).then(function (data) {
                            route.events.handler(data).then(function (data) {
        ...
        value: function findOutletByName(name) {
            ...
            var outlet = this._outlets.find(function (element) {
                var attr = element.attributes.getNamedItem(_this4._config.outletAttrName);
        ...
        value: function registerRoute() {
            if (typeof (arguments.length <= 0 ? undefined : arguments[0]) === 'function') {
                ...
                this._routes.push({
                    ...
                    events: Object.assign({}, defaultEventObject, arguments.length <= 1 ? undefined : arguments[1]) // TODO: if there are no handlers provided in the events object then throw exception.
                });
            }
        }
    }, {
